...
enum class ThemeTypes(
    ...
    GrayTheme("grayTheme", R.style.grayTheme, true, false, "Szary"),
    ...
    NTheme("nTheme", R.style.nTheme, false, false,"Nocny spacer"),
    DamianTheme("damianTheme", R.style.damianTheme, false, false,"Tajemniczy"),
    D2Theme("d2Theme", R.style.d2Theme, false, false,"Wiatr na pustyni"),
    G1Theme("g1Theme", R.style.g1Theme, false, false,"Gta"),
    G2Theme("g2Theme", R.style.g2Theme, false,  false,"Gta2")
}